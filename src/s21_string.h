...
#define ERRLIST                                                                \
  {                                                                            \
    "Error 0", "Operation not permitted", "No such file or directory",         \
        ...
        "Permission denied", "Bad address", "Not a block device",              \
        ...
        "Too many open files", "Inappropriate ioctl for device",               \
        "Text file busy", "File too large", "Device out of space",             \
        "Illegal seek", "Read-only file system", "Too many links",             \
        "Broken pipe", "Numerical argument out of domain",                     \
        ...
        "Socket type not supported", "Not supported",                          \
        ...
        "Too many levels of symbolic links", "File name too long",             \
        "Host is down", "No route to host", "Directory not empty",             \
        "Too many processes", "Too many users", "Disc quota exceeded",         \
        "Stale NFS file handle", "Bad RPC struct", "RPC version wrong",        \
        "RPC prog. not avail.", "Program version wrong",                       \
